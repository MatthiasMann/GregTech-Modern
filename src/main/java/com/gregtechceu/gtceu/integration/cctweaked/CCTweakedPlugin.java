...
public class CCTweakedPlugin {
    ...
    public static void init() {
        ...
        ComputerCraftAPI.registerGenericSource(new LargeTurbinePeripheral());
        ...
        ForgeComputerCraftAPI.registerGenericCapability(GTCapability.CAPABILITY_LARGE_TURBINE);
